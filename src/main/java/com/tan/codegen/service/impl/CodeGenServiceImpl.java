package com.tan.codegen.service.impl;
...
import com.tan.codegen.common.PageResult;
...
import com.tan.codegen.utils.CodeGenUtil;
import com.tan.codegen.utils.DbUtil;
...
public class CodeGenServiceImpl implements CodeGenService {
    ...
    private final String COLUMN_SQL_TEMPLATE = "select column_name columnName, data_type dataType, column_comment columnComment, column_key columnKey, extra,column_default columnDefault,is_nullable isNullable,character_maximum_length characterMaximumLength from information_schema.columns where table_name = ? and table_schema = (select database()) order by ordinal_position";
